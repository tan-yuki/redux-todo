...
export type FETCH_TODO_REQUEST_SUCCESS = "FETCH_TODO_REQUEST_SUCCESS";
export type FETCH_TODO_REQUEST_FAILURE = "FETCH_TODO_REQUEST_FAILURE";
...
export type ActionTypes = ADD_TODO                   |
                          ...
                          FETCH_TODO_REQUEST_SUCCESS |
                          FETCH_TODO_REQUEST_FAILURE;
